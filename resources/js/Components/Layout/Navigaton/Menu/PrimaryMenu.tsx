...
import NavLink from '@/Components/Layout/Navigaton/Links/NavLink';
                ...
                <div className='flex'>
                    ...
                    <div className='flex-shrink-0 flex items-center'>
                        <Link href={route('dashboard')}>
                            <Logo className='block h-9 w-auto text-white'></Logo>
                ...
                <div className='hidden sm:flex sm:items-center sm:ml-6'>
                    ...
                    <div className='ml-3 relative'>
                        <Dropdown
                          ...
                          <button
                              type='button'
                              className='inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150'
                          >
